 ...
 */
const BAND_IMG = "/brand/office-reception.jpg";
...
export default function OfficeBand() {
  return (
    <section className="relative w-full overflow-hidden" style={{ height: "clamp(360px, 54vh, 640px)" }}>
      <img
        src={BAND_IMG}
        alt="The Direct2YourDoc private reception"
        className="absolute inset-0 w-full h-full object-cover"
        style={{ objectPosition: "center", filter: "brightness(0.72) saturate(0.95)" }}
      />
      {/* Left scrim for text legibility */}
      <div
        className="absolute inset-0"
        style={{ background: "linear-gradient(90deg, oklch(0.10 0.05 200 / 0.94) 0%, oklch(0.10 0.05 200 / 0.5) 52%, oklch(0.10 0.05 200 / 0.15) 100%)" }}
      />

...
export default function StatsBar() {
  ...
  return (
    <section
      ref={ref}
      style={{
        backgroundColor: "oklch(0.15 0.010 60)",
        borderTop: "1px solid oklch(0.97 0.012 80 / 0.07)",
        borderBottom: "1px solid oklch(0.97 0.012 80 / 0.07)",
      }}
    >
      <div className="container">
        <div
          className="grid grid-cols-2 md:grid-cols-4"
          style={{ borderLeft: "1px solid oklch(0.97 0.012 80 / 0.07)" }}
        >
          {stats.map((stat, i) => (
            <div
              key={i}
              ...
              style={{
                ...
                borderRight: "1px solid oklch(0.97 0.012 80 / 0.07)",
              }}
            >
